        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Experience the simplicity of our platform with a streamlined process designed to get you managing your
              business professionally in minutes.
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              {[
                {
                  ...
                  description: "Get started with a free account in less than 60 seconds",
                },
                {
                  number: "2",
                  title: "Choose & Customize",
                  description: "Select a template and personalize it with your content and branding",
                },
                {
                  number: "3",
                  title: "Launch & Scale",
                  description: "Deploy your solution and start growing your business immediately",
                },
              ].map((step, index) => (
                <motion.div
                  key={step.number}
            ...
            >
              ...
              >
                ...
                <span className="text-white font-semibold">YourProduct Dashboard</span>
              </motion.div>
                ...
                >
                  ...
                  >
                    {[0, 1, 2, 3].map((i) => (
                      <motion.div
                        key={i}
                        className={`${i % 2 === 0 ? "bg-purple-500/20" : "bg-gray-500/20"} rounded-lg p-3 h-16`}
                        variants={scaleIn}
