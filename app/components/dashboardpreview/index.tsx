          ...
          >
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl flex items-center justify-center shadow-lg">
                <span className="text-white text-lg font-bold italic">B</span>
              </div>
              <span className="text-white font-semibold">
                <span className="italic font-thin">Business</span> Dashboard
              </span>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-300">Search for accounts, people, deals, etc.</span>
                </div>
