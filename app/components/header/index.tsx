    ...
    <motion.header
      ...
      >
        <div className="container mx-auto px-6 lg:px-12">
          <div className="backdrop-blur-xl bg-white/20 border border-white/20 rounded-2xl px-6 py-4 shadow-2xl">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                {["Learn", "Product", "Pricing", "Support", "Company", "Blog"].map((item, index) => (
                  <motion.div
                    key={item}
                  ...
                  >
                    ...
                    {(item === "Learn" || item === "Product" || item === "Support") && (
